...
* Add-on Management
    ...
    * Generate portable versioned addon archives from Python for release and source-tree use, and support FreekiCAD installation and removal through PySide-less Windows FreeCADCmd builds
* Panelizer
